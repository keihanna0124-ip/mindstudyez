      ...
      <div className="max-w-4xl space-y-6 py-6 relative z-10">
        <div className="flex flex-col items-center gap-2 animate-fade-in">
          ...
          <div className="space-y-4 overflow-visible">
            ...
            <div className="pt-4">
              <p className="inline-block px-4 py-1 rounded-lg bg-indigo-50 dark:bg-slate-800 text-indigo-500 dark:text-indigo-400 text-[10px] font-black uppercase tracking-widest">
